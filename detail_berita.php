...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <?php
      require_once('db.php');
      $sql1 = "SELECT * FROM halaman_index";
      ...
      <div class="container">
        <div class="row mb-5 ">
          <div class="col-md-7 section-title text-center mx-auto">
            <span class="sub-title mb-2 d-block"><?php echo $row["tanggal"];?></span>
            <h2 class="title mb-3" style="color: #297fb9">P<?php echo $row["judul"];?></h2>
          </div>
        </div>

        <div class="row mb-5">
          <div class="col-lg-6 mb-4 mb-lg-0">
            <img src="admin/images/<?php echo $row["foto"];?>" alt="Image" class="img-fluid">
          </div>
