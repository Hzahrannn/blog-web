...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <?php
        require_once('db.php');
        $id = $_GET['id'];
        $sql = "SELECT * FROM halaman_merchandise WHERE id='$id'";
        $result = $db->query($sql);
        while($row = $result->fetch_assoc()){
    ?>
    <form method="post" action="us19.php" enctype="multipart/form-data">
      ...
      <div class="container">
        ...
        <div class="row mb-5">
          ...
          <div class="col-lg-5 h-100 jm-sticky-top ml-auto">
            ...
            <input type="text" class="form-control" name="harga" value="<?php echo $row["harga"];?>"><br>
