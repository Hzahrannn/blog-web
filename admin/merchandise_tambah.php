...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <form method="post" action="us18.php" enctype="multipart/form-data">
    <div class="site-section" id="portfolio-section">
      <div class="container">
        <div class="row mb-5 ">
          <div class="col-md-7 section-title text-center mx-auto">
            <label for="exampleFormControlFile1">Nama Merchandise</label>
        ...
        <div class="row mb-5">
          <div class="col-lg-6 mb-4 mb-lg-0">
            ...
            <div class="form-group"><br>
              <label for="exampleFormControlFile1">Foto Merchandise</label>
