...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <?php
        require_once('db.php');
        $id = $_GET['id'];
        $sql = "SELECT * FROM halaman_berita WHERE id='$id'";
        $result = $db->query($sql);
        while($row = $result->fetch_assoc()){
    ?>
    <form method="post" action="us11.php" enctype="multipart/form-data">
    <div class="site-section" id="portfolio-section">
      <div class="container">
        <div class="row mb-5 ">
          <div class="col-md-7 section-title text-center mx-auto">
            <input type="hidden" class="form-control" name="id" value="<?php echo $row["id"];?>">
            <span class="sub-title mb-2 d-block"><label for="exampleFormControlFile1">Tangal Berita</label>
            <input type="text" class="form-control" name="tanggal" value="<?php echo $row["tanggal"];?>"></span>
            <label for="exampleFormControlFile1">Judul Berita</label>
        ...
        <div class="row mb-5">
          ...
          <div class="col-lg-5 h-100 jm-sticky-top ml-auto">
            <label for="exampleFormControlFile1">Header Berita</label>
            <input type="text" class="form-control" name="header" value="<?php echo $row["header"];?>"><br>
            <label for="exampleFormControlFile1">Isi Berita</label>
            <div class="form-group">
              <textarea class="form-control" id="exampleFormControlTextarea1" rows="10" name="isi"><?php echo $row["isi"];?></textarea>
            </div>
          </div>
        </div>
