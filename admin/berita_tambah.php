      ...
      <div class="container">
        <div class="row mb-5 ">
          <div class="col-md-7 section-title text-center mx-auto">
            <span class="sub-title mb-2 d-block"><label for="exampleFormControlFile1">Tangal Berita</label><input type="text" class="form-control" name="tanggal"></span>
        ...
        <div class="row mb-5">
          ...
          <div class="col-lg-5 h-100 jm-sticky-top ml-auto">
            ...
            <input type="text" class="form-control" name="header"><br>
