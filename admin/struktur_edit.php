...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <?php
        require_once('db.php');
        $id = $_GET['id'];
        $sql = "SELECT * FROM halaman_struktur WHERE id='$id'";
        $result = $db->query($sql);
        while($row = $result->fetch_assoc()){
    ?>
    <form method="post" action="us17.php" enctype="multipart/form-data">
    <div class="site-section" id="portfolio-section">
      <div class="container">
        <div class="row mb-5 ">
          <div class="col-md-7 section-title text-center mx-auto">
            <input type="hidden" class="form-control" name="id" value="<?php echo $row["id"];?>">
            <label for="exampleFormControlFile1">Nama Divisi</label>
            <input type="text" class="form-control" name="nama_divisi" value="<?php echo $row["nama_divisi"];?>">
          </div>
        </div>
        ...
        <div class="row mb-5">
          <div class="col-lg-6 mb-4 mb-lg-0">
            ...
            <div class="form-group"><br>
              <label for="exampleFormControlFile1">Foto Divisi</label>
            </div>
          </div>
          <div class="col-lg-5 h-100 jm-sticky-top ml-auto">
            <label for="exampleFormControlFile1">Anggota Divisi</label>
            <div class="form-group">
              <textarea class="form-control" id="exampleFormControlTextarea1" rows="10" name="anggota"><?php echo $row["anggota"];?></textarea>
            </div>
          </div>
        </div>
