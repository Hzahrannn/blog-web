...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <?php
        require_once('db.php');
        $id = $_GET['id'];
        $sql = "SELECT * FROM halaman_karir WHERE id='$id'";
        $result = $db->query($sql);
        while($row = $result->fetch_assoc()){
    ?>
    <form method="post" action="us21.php" enctype="multipart/form-data">
        ...
        <div class="row mb-5">
          ...
          <div class="col-lg-5 h-100 jm-sticky-top ml-auto">
            ...
            <div class="form-group">
              <textarea class="form-control" id="exampleFormControlTextarea1" rows="10" name="deskripsi"><?php echo $row["deskripsi"];?></textarea>
            </div>
          </div>
        </div>
