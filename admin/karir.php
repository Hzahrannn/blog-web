      ...
      <div class="container">
        ...
        <div class="row mb-5 ">
          <div class="col-md-7 section-title text-center mx-auto">
            <span class="sub-title mb-2 d-block">Info Karir</span>
            <h2 class="title mb-3" style="color: #297fb9">Info Karir</h2>
            <button data-toggle="modal" data-target="#daftar" type="button" class="btn btn-success">Tambah Info Karir Baru</button></a>
          </div>
        </div>
        ...
        ?>
          ...
          <div class="item web col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4">
            <a href="images/<?php echo $row["foto"];?>" class="item-wrap" data-fancybox="gal">
 ...
 <div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-header">
      <h4 class="modal-title">Masukan Info Karir Baru</h4>
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    </div>
    <form action="us14.php" method="POST" enctype="multipart/form-data">
